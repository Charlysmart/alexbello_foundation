        ...
        <div>
            ...
            <main className="text-gray-600">
                <div className="h-80 overflow-hidden relative">
                    ...
                    <p className="absolute bottom-5 left-5 text-white md:text-[1.3rem] text-[1.1rem] font-medium"><a href="./" className="text-white">Home</a> / <span className="text-orange-400">Empowerment Schemes</span></p>
                </div>
                <section className="lg:px-40 md:px-10 px-2 lg:m-15 md:m-10 my-10 mx-2">
                    <div className="space-y-5 shadow-2xl rounded-2xl md:p-10 p-5">
                        <h2 className="font-bold md:text-[2rem] text-[1.3rem]">AlexBello Foundation Empowerment Initiatives</h2>
                        <p className="md:text-[1.5rem] text-[1.2rem]">
                        ...
                        <h3 className="font-bold md:text-[2rem] text-[1.3rem]">Our Vision</h3>
                        <p className="md:text-[1.5rem] text-[1.2rem]">
                        ...
                        <h3 className="font-bold md:text-[2rem] text-[1.3rem]">Our Approach</h3>
                        <h4 className="font-semibold md:text-[1.5rem] text-[1.2rem]">Education & Skill Development</h4>
                        ...
                        <h4 className="font-semibold md:text-[1.5rem] text-[1.2rem]">Economic Empowerment</h4>
                        <p className="md:text-[1.2rem] text-[1rem]">
                        ...
                        <h4 className="font-semibold md:text-[1.5rem] text-[1.2rem]">Community Development</h4>
                        <p className="md:text-[1.2rem] text-[1rem]">
                        ...
                        <h4 className="font-semibold md:text-[1.5rem] text-[1.2rem]">Youth Empowerment</h4>
                        <p className="md:text-[1.2rem] text-[1rem]">
                        ...
                        <h3 className="font-bold md:text-[2rem] text-[1.3rem]">Our Impact</h3>
                        <p className="md:text-[1.5rem] text-[1.2rem]">
                        ...
                        <h3 className="font-bold md:text-[2rem] text-[1.3rem]">How You Can Support</h3>
                        <p className="md:text-[1.5rem] text-[1.2rem]">
                        ...
                        <h3 className="font-bold md:text-[2rem] text-[1.3rem]">Donate Now</h3>
                        <p className="md:text-[1.5rem] text-[1.2rem]">
