        ...
        <div className="flex flex-col">
            ...
            <main className="text-gray-700 bg-gray-100 flex-1">
                <div className="h-80 overflow-hidden relative">
                    ...
                    <p className="absolute bottom-5 left-5 text-white text-[1.3rem] font-medium"><a href="./" className="text-white">Home</a> / <span className="text-orange-400">Contact Us</span></p>
                </div>
                <div className="h-full flex items-center px-30 *:w-[49%] justify-between py-15">
                    <section className="space-y-5">
                        <h2 className="font-bold text-black text-[2.5rem]">Contact Us</h2>
                        <p className="text-[1.3rem]">Email, call or complete the form to get in touch with AlexBello Charity Foundation.</p>
                        <div className="flex gap-3 items-center text-[1.3rem]"><Mail className="text-blue-900" /><a href="mailto:alexbellocharityfoundation@gmail.com">alexbellocharityfoundation@gmail.com</a></div>
                        <div className="flex gap-3 items-center text-[1.3rem]"><PhoneCall className="text-blue-900" /><a href="tel:+2349169335195">+2349169335195</a></div>
                        <div className="flex gap-3 items-center text-[1.3rem]"><MapPin className="text-blue-900" /><address>No 12 our Lord's street, Ike Ekweremmadu road, independence layout, Enugu, Nigeria</address></div>
                    </section>
                    <section className="bg-white p-10 rounded-3xl shadow-2xl">
                        ...
                        <form action="" className="space-y-5 flex flex-wrap justify-between">
                            <div className="*:block space-y-2 shrink-0 w-[49%]">
