        ...
        <div>
            ...
            <main>
                <div className="h-80 overflow-hidden relative">
                    ...
                    <p className="absolute bottom-5 left-5 text-white text-[1.3rem] font-medium"><a href="./" className="text-white">Home</a> / <span className="text-orange-400">Events</span></p>
                </div>
                <h2 className="text-center font-bold text-orange-600 text-[2rem] mt-10">Stay Updated with AlexBello Charity Foundation</h2>
                <div className="flex w-full *:w-[48%] py-15 px-50 text-gray-700 justify-between gap-10 *:shrink-0 flex-wrap">
                    <section className="border h-120 rounded-3xl overflow-hidden border-gray-300 bg-white">
                        ...
                        <div className="py-5 px-5 space-y-5">
                            <p className="text-[1.2rem]">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aspernatur, quam consectetur assumenda aliquam deserunt ut, repudiandae eaque enim eum quibusdam, odit harum. Ullam fuga ipsam incidunt consequuntur officiis maxime.</p>
